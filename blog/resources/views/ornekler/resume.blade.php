                                ...
                                <nav class="navbar navbar-expand-lg navbar-light p-0">
                                    <div class="navbar-brand clearfix hidden-lg-up">
                                        ...
                                        <div id="logo-mobile" class="logo">
                                            <a href="index.html"><img id="logo-img-mobile" src="images/logo_dark_cyan.png" alt="The Project"></a>
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-8">
                                <div class="body">
                                    ...
                                    <p class="small mb-10"><i class="icon-calendar"></i> Feb, 2017 <i class="pl-10 icon-tag-1"></i> Web Design</p>
